    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || 'Review-ul nu a putut fi adaugat. Te rugam sa reincerci.');
            }
            ...
            setRating(0);
            setSuccess(true);
            navigate(`/services/${serviceId}/reviews`, { replace: true });
        } catch (err) {
        ...
        <Container maxWidth="md" sx={{ mt: 4, mb: 4 }}>
            <Paper elevation={3} sx={{ p: 4 }}>
                ...
                <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
                    ...
                    <Button
                        ...
                        disabled={loading}
                    >
                        {loading ? <CircularProgress size={24} /> : 'Adauga review'}
                    </Button>
                </Box>
            </Paper>
            ...
            <Snackbar open={success} autoHideDuration={6000} onClose={handleCloseSnackbar}>
                <Alert onClose={handleCloseSnackbar} severity="success" sx={{ width: '100%' }}>
                    Review-ul tau a fost adaugat cu succes!
                </Alert>
            </Snackbar>
        </Container>
    );
